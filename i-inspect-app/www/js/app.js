...
angular.module('starter', ['ionic', 'starter.controllers', 'ionic-material', 'checklist-model', 'ionMdInput', 'ngResource', 'ngRoute', 'starter.services','ngCordova', 'validation.match' ])
