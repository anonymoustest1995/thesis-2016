...
class Electronics extends REST_Controller {
    ...
    public function index_post()
    {
        ...
        if ($check) {
            ...
            $xdata = array(
                    'electronics_inspection_id' =>  $xid,
                    'installation_operation_description' => $this->post('installation_operation_description', TRUE),
                );
            $this->load->model('electronics_model','tbl_electronics');
            $id = $this->tbl_electronics->insert_electronics($xdata);
