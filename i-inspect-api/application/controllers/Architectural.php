...
class Architectural extends REST_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('architectural_model');
    ...
    public function index_post()
    {
        ...
        if ($check) {
            ...
            $xdata = array(
                    'archi_inspection_id'    =>  $xid,
                    'least_floor_to_celling' => $this->post('least_floor_to_celling', TRUE),
                    'estimated_ventilation'  => $this->post('estimated_ventilation', TRUE),
                );
            $this->load->model('architectural_model','tbl_architectural');
            $id = $this->tbl_architectural->insert_architectural($xdata);
