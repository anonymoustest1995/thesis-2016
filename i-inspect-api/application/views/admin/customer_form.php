  ...
  <!-- Content Header (Page header) -->
    ...
    <div class="con">
      <form class="form-horizontal" role="form" id="create-assign-form" method="post">
        <?php foreach ($datas as $person) : ?>
          <div id="formpage_1" style="visibility: visible; display: block;"> 
            <div class="form-group">
                <label class="control-label col-sm-5">Building Permit Number</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" name="building_permit_number" value="<?php echo $person->building_permit_number; ?>" readonly>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" name="customer_tin_no" value="<?php echo $person->customer_tin_no; ?>" readonly>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-5">Form of Ownership</label>
              <div class="col-sm-7">
                <input type="text" class="form-control" name="customer_form_of_ownership" value="<?php echo $person->customer_form_of_ownership; ?>" readonly>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" name="customer_tel_no" value="<?php echo $person->customer_tel_no; ?>" readonly>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-5">Type of Occupancy</label>
              <div class="col-sm-7">
                <input type="text" class="form-control" name="occupancy_type_description" value="<?php echo $person->occupancy_type_description; ?>" readonly>
              </div>
            </div>
            <div class="form-group">
        ...
        <!-- page 2 -->
            <div id="formpage_2" style="visibility: hidden; display: none;">
                ...
                <div class="form-group">
                        <label class="control-label col-sm-5"><?php echo $pos->position_description;?></label>
                        <input type="hidden" name="position_description">
                        <div class="col-sm-7">
                ...
                <ul class="pager">
                    ...
                    <li class="next"><a href="" type="button" id="save-assign-info">SAVE</a></li>
                </ul>
            </div>
      </form>
    </div>
      ...
      <h2>
        Occupancy Inspectors and Their Assigned Building Permit Numbers
      </h2>
