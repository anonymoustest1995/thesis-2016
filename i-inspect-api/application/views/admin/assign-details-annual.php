  ...
  <div class="content-wrapper">
    ...
    <h1>
        Annual Inspectors
        <small>And Their Assigned Occupancy Permit Numbers</small>
      </h1>
                ...
                <tbody>
                    <?php foreach ($assigned as $person) : ?>
                      <tr>
                          ...
                          <td><a href="<?php echo base_url() . "Users/delete_user/" . $person->assigned_id; ?>" onClick="return doconfirm()" class="link fa fa-trash-o" title="Delete"></a>
                          </td>
                      </tr>
                  <?php endforeach; ?> 
                </tbody>
