      ...
      <div class="panel panel-primary">
              ...
              <?php foreach ($occupancy as $person) : ?>
                  <div class="row">
                    <div class="col-sm-8 form-group">
                      <label>Occupancy Permit Number</label>
                        <span class="form-control"><?php echo $person->occupancy_number; ?></span>
                    </div>
          ...
          <div id="formpage_7" class="panel panel-success">
            ...
            <button  class="btn btn-success"> <i class="glyphicon glyphicon-ok"></i> 
              <a href="<?php echo base_url() . "admin/final-reports/" . $person->building_permit_number; ?>"
              >
                See Final Report
              </a>
             </button>
