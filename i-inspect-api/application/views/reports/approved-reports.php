          ...
          <div class="box">
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php foreach ($occupany as $person) : ?>
                        <tr>
                            ...
                            <td>
                            <a href="<?php echo base_url() . "Users/delete_user/" . $person->occupancy_number; ?>" onClick="return doconfirm()" class="link fa fa-trash-o" title="Delete"></a>
                                &nbsp;&nbsp;
                            <a href="<?php echo base_url() . "admin/detailed-occupancy-reports/" . $person->building_permit_number; ?>" title="VIEW Detailed Report" target="_blank"><i class="fa fa-pencil-square-o"></i> View</a>
                            </td>
                        </tr>
                    <?php endforeach; ?> 
                </tbody>
